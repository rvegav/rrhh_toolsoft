	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>vacaciones/vacaciones/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Escala de Vacaciones
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_vacaciones" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>Desde (Años)</th>
									<th>Hasta (Años)</th>
							...
							<tbody>
								...
								<tr>
									<td>
										<?php echo $vacacion->DESDE;?>
									</td>
									<td>
										<?php echo $vacacion->HASTA;?>
									</td>
									<td>
										<?php echo $vacacion->CANTIDADDIAS;?>
									</td>
									<td>
										<?php echo $vacacion->FECGRABACION;?>
									</td>
									...
									<td>
										...
										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $vacacion->IDVACACION;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>vacaciones/vacaciones/edit/<?php echo $vacacion->IDVACACION;?>" class="btn btn-warning">
											<i class="fa fa-edit"></i>
										</a>
										<a href="#" id="<?=$vacacion->IDVACACION;?>" class="btn btn-danger btn-delete eliminar">
											<i class="fa fa-trash">
											</i>
										</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles de Escala de Vacaciones </h4>
		  	</div>
...
<script>
 $(document).ready(function(){
 	$('#tb_vacaciones thead tr').clone(true).appendTo( '#tb_vacaciones thead' );
		$('#tb_vacaciones thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_vacaciones').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "20%", "targets": 5 }],
			"orderCellsTop": true,
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "vacaciones/vacaciones/view/" + id,
            type: "POST",
...
.then((willDelete) => {
  if (willDelete) {
   window.location.href = "/isupport/vacaciones/vacaciones/delete/" + id;
  }
});
});
