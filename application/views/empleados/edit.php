											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												...
												<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
													<div class="profile_img">
														<div id="crop-avatar">
															<!-- Current avatar -->
															<img class="card-img-top imagenredonda" id="imgSalida" src="<?php echo $empleado->PERFIL?>">
														</div>
													</div>
												...
												<div class="col-md-7 col-sm-7 col-xs-12">
													...
													<div class="form-group <?php echo !empty(form_error("CodEmpleado"))? 'has-error':'';?>">
														...
														<div class="col-md-3 col-sm-3 col-xs-12">
															<input type="text" class="form-control" id="CodEmpleado" name="CodEmpleado" value="<?php echo $empleado->IDEMPLEADO ?>">
														</div>
													</div>
													...
													<div class="form-group <?php echo !empty(form_error("Nombre"))? 'has-error':'';?>">
														...
														<div class="col-md-9 col-sm-9 col-xs-12">
															<input id="Nombre" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="Nombre" placeholder="both name(s) e.g Jon Doe" type="text" value="<?php echo $empleado->NOMBRE?>">
														</div>
													</div>
													...
													<div class="form-group <?php echo !empty(form_error("Apellido"))? 'has-error':'';?>">
														...
														<div class="col-md-9 col-sm-9 col-xs-12">
															<input type="text" id="Apellido" placeholder="Descripcion" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"  name="Apellido" class="form-control col-md-7 col-xs-12" value="<?php echo $empleado->APELLIDO?>">
									...
									<div class="tab-pane" role="tabpanel" id="step2">
										...
										<div class="row">
											<div class='col-sm-6'>
												...
												<div class="form-group">
													<div class="col-md-9 col-sm-9 col-xs-12">
														<input type="text" id="Documento" placeholder="Documento de Identidad" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"  name="Documento" class="form-control col-md-7 col-xs-12" value="<?php echo $empleado->CEDULAIDENTIDAD?>">
											...
											<div class='col-sm-6'>
												...
												<div class="form-group">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<input type="date" id="Nacimiento" placeholder="Nacimiento" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"  name="Nacimiento" class="form-control col-md-7 col-xs-12" value="<?php echo $empleado->FECNACIMIENTO ?>">
											...
											<div class='col-sm-6'>
												...
												<div class="form-group">
													<div class="col-md-9 col-sm-9 col-xs-12">
														<input type="text" id="Direccion" placeholder="Direccion" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"  name="Direccion" class="form-control col-md-7 col-xs-12" value="<?php echo $empleado->DIRECCION ?>">
											...
											<div class='col-sm-6'>
												...
												<div class="form-group">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<input type="date" id="Ingreso" placeholder="Fecha de Ingreso" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"  name="Ingreso" class="form-control col-md-7 col-xs-12" value="<?php echo $empleado->FECHAINGRESO ?>">
											...
											<div class='col-sm-6'>
												...
												<div class="form-group">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<input type="text" id="Telefono" placeholder="Telefono" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"  name="Telefono" class="form-control col-md-7 col-xs-12" value="<?php echo $empleado->TELEFONO ?>">
											...
											<div class='col-sm-6'>
												...
												<div class="form-group">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<input type="date" id="Salida" placeholder="Fecha de Salida" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"  name="Salida" class="form-control col-md-7 col-xs-12" value="<?php echo $empleado->FECHASALIDA ?>">
											...
											<div class='col-sm-6'>
												...
												<div class="form-group">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<input type="text" id="Celular" placeholder="Celular" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();"  name="Celular" class="form-control col-md-7 col-xs-12" value="<?php echo $empleado->CELULAR ?>">
													...
													<div class="col-md-6 col-sm-6 col-xs-12"> 
														...
														<select class="form-control select2" style="width: 100%;" name="NivelEstudio" id="NivelEstudio">
															...
															<?php foreach($nivelestudios as $nivelestudio):?>
																<?php if ($nivelestudio->DESNIVEL != $empleado->NIVEL): ?>
																	<option value="<?php echo $nivelestudio->IDNIVEL;?>"><?php echo $nivelestudio->DESNIVEL;?></option>
													...
													<select class="form-control select2" style="width: 100%;" name="EstadoCivil" id="EstadoCivil">
														...
														<?php foreach($estadociviles as $estadocivil):?>
															<?php if($estadocivil->DESCIVIL != $empleado->DESCIVIL):?>
																<option value="<?php echo $estadocivil->IDCIVIL?>"><?php echo $estadocivil->DESCIVIL;?></option>
															<?php endif;?>
														<?php endforeach;?>
													</select>
												</div>
														...
														<select class="form-control select2" style="width: 100%;" name="Ciudad" id="Ciudad">
															...
															<?php foreach($ciudades as $ciudad):?>
																<?php if($ciudad->DESCIUDAD!= $empleado->CIUDAD):?>
																	<option value="<?php echo $ciudad->IDCIUDAD?>"><?php echo $ciudad->DESCIUDAD;?></option>
																<?php endif;?>
															<?php endforeach;?> 
														</select>
													</div>
														...
														<select class="form-control select2" style="width: 100%;" name="Departamento" id="Departamento">
															...
															<?php foreach($depatamentosempresas as $departempresa):?>
																<?php if($departempresa->DESDEPARTAMENTO != $empleado->DEPARTAMENTO):?>
																	<option value="<?php echo $departempresa->IDEMPRESA?>"><?php echo $departempresa->DESDEPARTAMENTO;?></option>
																<?php endif;?>
															<?php endforeach;?>
														</select>
													</div>
												...
												<div class="form-group">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<select class="form-control select2" style="width: 100%;" name="Cargo" id="Cargo">
															<optgroup label="Cargo Actual"></optgroup>
															<option value="<?php echo $empleado->IDCARGO ?>"><?php echo $empleado->CARGO ?></option>
															<optgroup label="Cargo a Asignar"></optgroup>
															<?php foreach($cargos as $cargo):?>
																<?php if($cargo->DESCARGO != $empleado->CARGO):?>
																	<option value="<?php echo $cargo->IDCARGO?>"><?php echo $cargo->DESCARGO;?></option>
																<?php endif;?>
															<?php endforeach;?>
														</select>
													</div>
