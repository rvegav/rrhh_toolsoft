<div class="right_col" role="main">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<?php endif; ?>
			<div class="x_title">
				<h2>Resumen de sueldos y Jornales| Generar</h2>
				<div class="clearfix"></div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<form id="frm_generar" name="frm_generar" data-parsley-validate="" class="form-horizontal form-label-left" method="POST" action="<?php echo base_url() ?>resumen_sueldo" novalidate="">
