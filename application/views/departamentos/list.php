							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $departamento->IDDEPARTAMENTO;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>departamentos/departamentos/edit/<?php echo $departamento->IDDEPARTAMENTO;?>" class="btn btn-warning">
											<i class="fa fa-pencil">
											</i>
										</a>
                                       <a href="#" id="<?=$departamento->IDDEPARTAMENTO;?>" class="btn btn-danger btn-delete eliminar">
...
function eliminar__(id){
	if(confirm("Esta seguro que desea eliminar este registro?")){
		...
		window.location.href = "/isupport/departamentos/departamentos/delete/" + id;
