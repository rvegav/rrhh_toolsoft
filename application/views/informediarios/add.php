<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_title">
                <h2>Infome de Libro Diario | Generar</h2>

                <div class="clearfix"></div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <form id="demo-form2" name="prueba1" data-parsley-validate="" class="form-horizontal form-label-left" action="<?php echo base_url()?>informe_libro_diario" method="POST" novalidate="">
