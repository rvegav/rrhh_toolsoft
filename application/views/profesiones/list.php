	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>profesiones/profesiones/add" class="btn btn-dark">
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_profesiones" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>#</th>
									<th>Código</th>
							...
							<tbody>
								...
								<tr>
									<td>
										<?php echo $profesion->IDPROFESION; ?>
									</td>
									<td>
										<?php echo $profesion->NUMPROFESION;?>
									</td>
									<td>
										<?php echo $profesion->DESPROFESION;?>
									</td>
									<td>
										<?php echo $profesion->FECGRABACION;?>
									</td>
									...
									<td>
										...
										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $profesion->IDPROFESION;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>profesiones/profesiones/edit/<?php echo $profesion->IDPROFESION;?>" class="btn btn-warning">
											<i class="fa fa-edit">
											</i>
										</a>
										<a href="<?php echo base_url();?>profesiones/profesiones/delete/<?=$profesion->IDPROFESION;?>" class="btn btn-danger btn-delete eliminar">
											<i class="fa fa-trash">
											</i>
										</a>
									</td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles de Profesion </h4>
		  	</div>
...
<script>
 $(document).ready(function(){
 	$('#tb_profesiones thead tr').clone(true).appendTo( '#tb_profesiones thead' );
		$('#tb_profesiones thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_profesiones').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "20%", "targets": 5 }],
			"orderCellsTop": true,
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "profesiones/profesiones/view/" + id,
            type: "POST",
