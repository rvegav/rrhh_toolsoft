	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>empresas/empresas/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Empresa
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_empresas" class="table table-striped table-bordered btn-hover table-responsive" width="100%" >
							<thead>
								<tr>
									<th>#</th>
								...
								if(!empty($empresas)):?>
									...
									foreach($empresas as $empresa):?>
										<tr>
											...
											<td><?php echo $empresa->NOMFANTASIA;?></td>
											<td><?php echo $empresa->NOMCONTRIBUYENTE;?></td>
											<td><?php echo $empresa->RUCCONTRIBUYENTE;?></td>
											<td><?php echo $empresa->DESEMPRESA;?></td>
									...
									// 	}
									// }
									$date_added = $empresa->FECGRABACION;
									...
									<td>
										...
										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $empresa->IDEMPRESA;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>empresas/empresas/edit/<?php echo $empresa->IDEMPRESA;?>" class="btn btn-warning">
											<i class="fa fa-edit">
											</i>
										</a>

										<a href="<?php echo base_url();?>empresas/empresas/delete/<?php echo $empresa->IDEMPRESA;?>" class="btn btn-danger btn-delete">
											<i class="fa fa-trash">
											</i>
										</a>
									</td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles de la Empresa </h4>
			</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#tb_empresas thead tr').clone(true).appendTo( '#tb_empresas thead' );
		$('#tb_empresas thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_empresas').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "50", "targets": 9 }],
			"orderCellsTop": true,
...
var base_url= "<?php echo base_url();?>";
       ...
       $(".btn-view").on("click", function(){
       	var id= $(this).val();
       	$.ajax({
       		url: base_url + "empresas/empresas/view/" + id,
       		type: "POST",
