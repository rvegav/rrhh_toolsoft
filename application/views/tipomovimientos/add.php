                        ...
                        <?php if(!empty($cuentacontables)):?>
                            <?php foreach($cuentacontables as $cuentacontable):?>
                                <tr>
                                    ...
                                    <td><button type = "button" class="btn btn-success btn-check2" id="placuentaSelect" value="<?php echo $cuentacontable->IDPLANCUENTA;?>"><span class= "fa fa-check"></span></button></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </tbody>
