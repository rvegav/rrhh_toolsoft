		...
		<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-12">
                    	...
                    	<div class="form-group <?php echo !empty(form_error("NumCuentacontable"))? 'has-error':'';?>">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                 <input type="text" name="NumCuentacontable" id = "NumCuentacontable" class="form-control" data-inputmask="9.99.99.99.999" pattern="[1-9]" placeholder="CUENTA"> 
                            </div>
                        </div>


                    <div class="form-group <?php echo !empty(form_error("subCuenta"))? 'has-error':'';?>">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subCuenta">Sub-Cuenta <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="subCuenta" placeholder="Sub-Cuenta" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();" required="required" value="<?php echo !empty(form_error("subCuenta"))? set_value("subCuenta"):'';?>" name="subCuenta" class="form-control col-md-7 col-xs-12">
				...
				<div class="form-group">
                     <div class="form-check form-check-inline">
                        ...
                        <div class="col-md-2">
                        	<div class="col-md-6 col-sm-6 col-xs-12">
  								<input type="radio" class="form-check-input" id="materialInline1" name="inlineMaterialRadiosExample" value="1">
  								<label class="form-check-label" for="materialInline1">Si</label>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-12">
  								<input type="radio" class="form-check-input" id="materialInline2" name="inlineMaterialRadiosExample" value="0" checked>
