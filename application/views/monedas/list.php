	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>monedas/monedas/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Moneda
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_monedas" class="table table-striped table-bordered btn-hover">
							<thead>
								<tr>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<?php echo $moneda->SIMBOLO;?>
									</td>
									<td>
										<?php echo $moneda->DECIMALES;?>
									</td>								
									
									<td>

										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $moneda->IDMONEDA;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>monedas/monedas/edit/<?php echo $moneda->IDMONEDA;?>" class="btn btn-warning">
											<i class="fa fa-edit">
											</i>
										</a>
										<a href="#" id="<?=$moneda->IDMONEDA;?>" class="btn btn-danger btn-delete eliminar">
											<i class="fa fa-trash">
											</i>
										</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles de la Moneda </h4>
		  	</div>
...
<script>
 $(document).ready(function(){
 	$('#tb_monedas thead tr').clone(true).appendTo( '#tb_monedas thead' );
		$('#tb_monedas thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_monedas').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "20%", "targets": 4 }],
			"orderCellsTop": true,
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "monedas/monedas/view/" + id,
            type: "POST",
...
.then((willDelete) => {
  if (willDelete) {
   window.location.href = "/isupport/monedas/monedas/delete/" + id;
  }
});
});
