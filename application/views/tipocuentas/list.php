	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>tipocuentas/tipocuentas/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Tipo de Cuenta
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_tipoCuentas" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>#</th>
									<th>Código</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<?php echo $tipocuenta->FECGRABACION;?>
									</td>
									...
									<td>
										...
										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $tipocuenta->IDTIPOCUENTA;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>tipocuentas/tipocuentas/edit/<?php echo $tipocuenta->IDTIPOCUENTA;?>" class="btn btn-warning">
											<i class="fa fa-edit">
											</i>
										</a>
										<a href="#" id="<?=$tipocuenta->IDTIPOCUENTA;?>" class="btn btn-danger btn-delete eliminar">
											<i class="fa fa-trash">
											</i>
										</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles del Tipo de Cuenta </h4>
		  	</div>
...
<script>
 $(document).ready(function(){
 	$('#tb_tipoCuentas thead tr').clone(true).appendTo( '#tb_tipoCuentas thead' );
		$('#tb_tipoCuentas thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_tipoCuentas').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "20%", "targets": 5 }],
			"orderCellsTop": true,
			"buttons": [{
				extend: 'pdfHtml5',
				text: 'Generar PDF',
				title:'Lista de Tipo de Cuentas' ,
				exportOptions: {
                    columns: [ 0, 1, 2, 3, 4 ]
                }, 
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "tipocuentas/tipocuentas/view/" + id,
            type: "POST",
 ...
 function eliminar__(id){
	if(confirm("Esta seguro que desea eliminar este registro?")){
		...
		window.location.href = "/isupport/tipocuentas/tipocuentas/delete/" + id;
