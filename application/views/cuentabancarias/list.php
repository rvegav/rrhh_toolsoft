	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>cuentabancarias/cuentabancarias/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Cuenta Bancaria
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_cuentasBancarias" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>Cuenta</th>
									<th>Banco</th>
							...
							<tbody>
								...
								<tr>
									<td>
										<?php echo $cuenta->NUMCUENTA;?>
									</td>
									<td>
										<?php echo $cuenta->DESBANCO;?>
									</td>
									<td>
										<?php echo $cuenta->DESTIPOCUENTA;?>
									</td>
									<td>
										<?php echo $cuenta->MONEDA;?>
									</td>								
									<td>
										<?php echo $cuenta->FECHAPERTURA;?>
									</td>	
									<td>
										<?php echo $cuenta->SALDOINICIAL;?>
									</td>								
									
									<td>

										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $cuenta->NUMCUENTA.".".$cuenta->IDBANCO;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>cuentabancarias/cuentabancarias/edit/<?php echo $cuenta->NUMCUENTA.".".$cuenta->IDBANCO;?>" class="btn btn-warning">
											<i class="fa fa-edit">
											</i>
										</a>									
										<a href="#" id="<?=$cuenta->NUMCUENTA.".".$cuenta->IDBANCO;?>" class="btn btn-danger btn-delete eliminar">
											<i class="fa fa-trash">
											</i>
										</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles de la Cuenta Bancaria </h4>
		  	</div>
...
<script>
 $(document).ready(function(){
 	$('#tb_cuentasBancarias thead tr').clone(true).appendTo( '#tb_cuentasBancarias thead' );
		$('#tb_cuentasBancarias thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_cuentasBancarias').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "20%", "targets": 6 }],
			"orderCellsTop": true,
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "cuentabancarias/cuentabancarias/view/" + id,
            type: "POST",
