	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_cargos" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>#</th>
									<th>Código Cargos</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<?php echo $cargo->NUMCARGO;?>
									</td>
									<td>
										<?php echo $cargo->DESCARGO;?>
									</td>
									<td>
										<?php echo $cargo->FECGRABACION;?>
									</td>
...
<script>
 $(document).ready(function(){
 	$('#tb_cargos thead tr').clone(true).appendTo( '#tb_cargos thead' );
		$('#tb_cargos thead tr:eq(1) th').each( function (i) {
