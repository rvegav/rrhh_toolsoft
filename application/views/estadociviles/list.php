	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>estadociviles/estadociviles/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Estado Civil
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_estadoCivil" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>#</th>
									<th>Código</th>
							...
							<tbody>
								<?php
								if(!empty($estadociviles)):?>
								<?php
								foreach($estadociviles as $estadocivil):?>
								<tr>
									<td>
										<?php echo $estadocivil->IDCIVIL; ?>
									</td>
									<td>
										<?php echo $estadocivil->NUMCIVIL;?>
									</td>
									<td>
										<?php echo $estadocivil->DESCCIVIL;?>
									</td>
									<td>
										<?php echo $estadocivil->FECGRABACION;?>
									</td>
									...
									<td>
										...
										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $estadocivil->IDCIVIL;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>estadociviles/estadociviles/edit/<?php echo $estadocivil->IDCIVIL;?>" class="btn btn-warning">
											<i class="fa fa-edit">
											</i>
										</a>
										<a href="#" id="<?=$estadocivil->IDCIVIL;?>" class="btn btn-danger btn-delete eliminar">
											<i class="fa fa-trash">
											</i>
										</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles de Estado Civiles </h4>
		  	</div>
...
<script>
 $(document).ready(function(){
 	$('#tb_estadoCivil thead tr').clone(true).appendTo( '#tb_estadoCivil thead' );
		$('#tb_estadoCivil thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_estadoCivil').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "20%", "targets": 5 }],
			"orderCellsTop": true,
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "estadociviles/estadociviles/view/" + id,
            type: "POST",
