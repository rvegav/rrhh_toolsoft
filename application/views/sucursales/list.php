	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>sucursales/sucursales/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Sucursal
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_sucursales" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>#</th>									
									<th>Sucursal</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<?php echo $sucursal->FECGRABACION;?>
									</td>									
									<td>

										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $sucursal->IDSUCURSAL;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>sucursales/sucursales/edit/<?php echo $sucursal->IDSUCURSAL;?>" class="btn btn-warning">
											<i class="fa fa-edit">
											</i>
										</a>

                                       <a href="#" id="<?=$sucursal->IDSUCURSAL;?>" class="btn btn-danger btn-delete eliminar">
											<i class="fa fa-trash">
											</i>
										</a>

										<!--<a href="#" id="<?=$ciudad->IDCIUDAD;?>"  class="btn btn-danger btn-xs eliminar"><i class="fa fa-trash"></i>Eliminar</a>-->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles de la Sucursal </h4>
		  	</div>
...
<script>
 $(document).ready(function(){
 	$('#tb_sucursales thead tr').clone(true).appendTo( '#tb_sucursales thead' );
		$('#tb_sucursales thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_sucursales').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "20%", "targets": 5 }],
			"orderCellsTop": true,
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "sucursales/sucursales/view/" + id,
            type: "POST",
