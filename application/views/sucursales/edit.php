					...
					<div class="col-md-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="DesSucursal" placeholder="Sucursal" required="required" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();" value="<?php echo $sucursal->DESSUCURSAL;?>" name="DesSucursal" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
