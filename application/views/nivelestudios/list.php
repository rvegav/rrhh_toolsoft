	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>nivelestudios/nivelestudios/add" class="btn btn-dark">
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_nivelEstudio" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>#</th>
									<th>Código</th>
							...
							<tbody>
								...
								if(!empty($nivelestudios)):?>
									...
									foreach($nivelestudios as $nivelestudio):?>
										<tr>
											<td>
												<?php echo $nivelestudio->IDNIVEL; ?>
											</td>
											<td>
												<?php echo $nivelestudio->NUMNIVEL;?>
											</td>
											<td>
												<?php echo $nivelestudio->DESNIVEL;?>
											</td>
											<td>
												<?php echo $nivelestudio->FECGRABACION;?>
											</td>
									...
									//$estado = $empleado->estadoEmpleado;
											...
											<td>
												...
												<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $nivelestudio->IDNIVEL;?>">
													<i class="fa fa-eye">
													</i>
												</button>
												<a href="<?php echo base_url();?>nivelestudios/nivelestudios/edit/<?php echo $nivelestudio->IDNIVEL;?>" class="btn btn-warning">
													<i class="fa fa-edit">
													</i>
												</a>
												<a href="#" id="<?=$nivelestudio->IDNIVEL;?>" class="btn btn-danger btn-delete eliminar">
													<i class="fa fa-trash">
													</i>
												</a>
											</td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles del Nivel de Estudio </h4>
			</div>
...
<script>
	$(document).ready(function(){
		$('#tb_nivelEstudio thead tr').clone(true).appendTo( '#tb_nivelEstudio thead' );
		$('#tb_nivelEstudio thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_nivelEstudio').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "20%", "targets": 5 }],
			"orderCellsTop": true,
...
var base_url= "<?php echo base_url();?>";
       ...
       $(".btn-view").on("click", function(){
       	var id= $(this).val();
       	$.ajax({
       		url: base_url + "nivelestudios/nivelestudios/view/" + id,
       		type: "POST",
