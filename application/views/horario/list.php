	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>horario/Horario/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Horario
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<!-- <div class="col-md-12"> -->
						<table id="tb_horario" class="table table-striped table-bordered btn-hover table-responsive" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								if(!empty($horarios)):?>
									...
									foreach($horarios as $horario):?>
										<tr>
											<td><?php echo $horario->IDHORARIO; ?></td>
											<td><?php echo $horario->DESCHORARIO;?></td>
											<td>
												<button value ="<?php echo $horario->IDHORARIO;?>" class="btn btn-primary ver_detalle" data-toggle="tooltip" data-placement="top" data-original-title="Ver Detalle Horario"><i class="fa fa-eye"></i></button>
												<a href="<?php echo base_url();?>horario/Horario/edit/<?php echo $horario->IDHORARIO;?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
												<a href="<?php echo base_url();?>horario/Horario/delete/<?php echo $horario->IDHORARIO;?>" class="btn btn-danger btn-delete eliminar"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								<?php endif; ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles del Horario </h4>
			</div>
...
<script type="text/javascript" >
	$(".ver_detalle").on('click', function(){
		...
		$.ajax({
			...
			for (var i = 0; i < valorespuesta.length; i++) {

				html+='<tr>';
				html+='<td class="text-center">'+valorespuesta[i].DIANRO+'</td>';
				html+='<td class="text-center">'+valorespuesta[i].DESCDIA+'</td>';
				html+='<td class="text-center">'+valorespuesta[i].ENTRADAAM+'</td>';
				html+='<td class="text-center">'+valorespuesta[i].SALIDAAM+'</td>';
				html+='<td class="text-center">'+valorespuesta[i].ENTRADAPM+'</td>';
				html+='<td class="text-center">'+valorespuesta[i].SALIDAPM+'</td>';
				html+='</tr>';
			}
