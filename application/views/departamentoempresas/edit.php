<div class="right_col" role="main">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="row">
					<div class="col-md-12">
						<form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="<?php echo base_url();?>departamentoempresas/departamentoempresas/update"  method="POST" novalidate="">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="NumDepartamento">Codigo <span class="required">*</span>
                        </label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input type="text" id="NumDepartamento" required="required" readonly value="<?php echo $departamentoempresa->NUMDEPARTAMENTO;?>" name="NumDepartamento" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
