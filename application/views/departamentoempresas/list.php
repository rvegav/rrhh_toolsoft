	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>departamentoempresas/departamentoempresas/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Departamento
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_dptoEmpresa" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>#</th>
							...
							<tbody>
								...
								<tr>
									<td>
										<?php echo $departamentoempresa->IDDEPARTEMENTO; ?>
									</td>
									<td>
									...
									<td>
										<?php echo $departamentoempresa->FECGRABACION;?>
									</td>
									...
									<td>
										...
										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $departamentoempresa->IDDEPARTEMENTO;?>">
											<i class="fa fa-eye">
											</i>
										</button>
...
<script>
 $(document).ready(function(){
 	$('#tb_dptoEmpresa thead tr').clone(true).appendTo( '#tb_dptoEmpresa thead' );
		$('#tb_dptoEmpresa thead tr:eq(1) th').each( function (i) {
		...
		var table = $('#tb_dptoEmpresa').DataTable({
			dom: 'Bfrtip',
			"columnDefs": [
			{ "width": "20%", "targets": 5 }],
			"orderCellsTop": true,
			"buttons": [{
				extend: 'pdfHtml5',
				text: 'Generar PDF',
				title:'Lista de Departamentos de la Empresa' ,
				exportOptions: {
                    columns: [ 0, 1, 2, 3, 4 ]
                }, 
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "departamentoempresas/departamentoempresas/view/" + id,
            type: "POST",
