	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>paises/paises/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Pais
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_pais" class="table table-striped table-bordered btn-hover table-responsive" width="100%">
							<thead>
								<tr>
									<th>#</th>
									<th>Código Pais</th>
								...
								if(!empty($paises)):?>
									...
									foreach($paises as $pais):?>
										<tr>
											...
											<td><?php echo $pais->NUMPAIS;?></td>
											<td><?php echo $pais->DESPAIS;?></td>
											<td><?php echo $pais->FECGRABACION;?></td>
											<?php
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles de la Pais </h4>
			</div>
...
<script>
	$(document).ready(function(){
		$('#tb_pais thead tr').clone(true).appendTo( '#tb_pais thead' );
		$('#tb_pais thead tr:eq(1) th').each( function (i) {
...
var base_url= "<?php echo base_url();?>";
       ...
       $(".btn-view").on("click", function(){
       	var id= $(this).val();
       	$.ajax({
       		url: base_url + "paises/paises/view/" + id,
       		type: "POST",
