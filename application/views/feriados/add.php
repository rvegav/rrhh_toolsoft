<div class="right_col" role="main">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="row">
					<div class="col-md-12">
						<form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="<?php echo base_url()?>feriados/feriados/store" method="POST">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input type="date" id="Fecha" placeholder="Ingrese Fecha" min="1" required="required" name="Fecha" class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="form-group <?php echo !empty(form_error("Motivo"))? 'has-error':'';?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="Motivo" placeholder="Descripcion" font style="text-transform: uppercase;" onkeyup="javascript:this.value = this.value.toUpperCase ();" required="required" value="<?php echo !empty(form_error("Motivo"))? set_value("Motivo"):'';?>" name="Motivo" class="form-control col-md-7 col-xs-12">
