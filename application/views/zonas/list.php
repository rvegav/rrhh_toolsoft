	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>zonas/zonas/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar 
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_zonas" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>#</th>
									<th>Código Zona</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<?php echo $zona->FECGRABACION;?>
									</td>
									
									
									<td>

										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $zona->IDZONA;?>">
											<i class="fa fa-eye">
											</i>
										</button>
										<a href="<?php echo base_url();?>zonas/zonas/edit/<?php echo $zona->IDZONA;?>" class="btn btn-warning">
											<i class="fa fa-pencil">
											</i>
										</a>
                                       <a href="#" id="<?=$zona->IDZONA;?>" class="btn btn-danger btn-delete eliminar">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles de Zona </h4>
		  	</div>
...
<script>
 $(document).ready(function(){
 	$('#tb_zonas thead tr').clone(true).appendTo( '#tb_zonas thead' );
		$('#tb_zonas thead tr:eq(1) th').each( function (i) {
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "zonas/zonas/view/" + id,
            type: "POST",
...
function eliminar__(id){
	if(confirm("Esta seguro que desea eliminar este registro?")){
		...
		window.location.href = "/isupport/zonas/zonas/delete/" + id;
