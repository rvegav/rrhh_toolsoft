	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-12" align="right">
				<a href="<?php echo base_url();?>bancos/bancos/add" class="btn btn-dark">
					<i class="fa fa-plus">
					</i> Agregar Banco
				</a>
				<?php
			...
			<div class="x_panel">
				...
				<div class="row">
					<div class="col-md-12">
						<table id="tb_bancos" class="table table-striped table-bordered btn-hover" width="100%">
							<thead>
								<tr>
									<th>#</th>
									<th>Código Banco</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<button type="button" class="btn btn-primary btn-view" data-toggle="modal" data-target="#modal-view" value="<?php echo $banco->IDBANCO;?>">
											<i class="fa fa-eye"></i>
										</button>
										<a href="<?php echo base_url();?>bancos/bancos/edit/<?php echo $banco->IDBANCO;?>" class="btn btn-warning">
											<i class="fa fa-edit"></i>
										</a>
										<a href="#" id="<?=$banco->IDBANCO;?>" class="btn btn-danger btn-delete eliminar">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class='fa fa-eye'></i> Ver Detalles del Banco </h4>
		  	</div>
...
<script>
 $(document).ready(function(){
 	$('#tb_bancos thead tr').clone(true).appendTo( '#tb_bancos thead' );
 	...
 	var base_url= "<?php echo base_url();?>";
       // alert (base_url);
        $(".btn-view").on("click", function(){
          var id= $(this).val();
          $.ajax({
            url: base_url + "bancos/bancos/view/" + id,
            type: "POST",
